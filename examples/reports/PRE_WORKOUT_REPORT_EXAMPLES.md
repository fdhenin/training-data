...
## Example 1: Rest Day — No Sessions Scheduled

```
Data last_updated (UTC): 2026-01-18T08:15:22

Weather (Klampenborg): 🌧 3°C, 88% humidity, Light rain, wind 6.2 m/s from the west.
Coach note: Good day to stay indoors and recover.
...
Planned Workouts for Today (Planned TSS: 0):
Rest day — no sessions scheduled.

Next session: Sunday — 3x10min Threshold @ 260W (TSS 88)

Recommendation: Go (rest day)

Interpretation:
Readiness: Good. HRV 58 is above 7d average, RHR 44 is below baseline, sleep solid at 8.5h.
TSB +1.85 = fresh and recovering. Rest day is doing its job — you'll be primed for tomorrow's
threshold session. Enjoy the day off. 💤
```

---

## Example 2: Endurance Day — Normal Readiness

```
Data last_updated (UTC): 2026-01-19T07:45:33

Weather (Klampenborg): ☁ 2°C, 75% humidity, Overcast, wind 5.1 m/s from the south.
Coach note: Cold but calm — fine for outdoor if you wanted, but trainer works too.
...
Planned Workouts for Today (Planned TSS: 71):
SkiErg 10min Zone 2
Endurance 2h — 15min 153W • 1h30min 162W • 15min 150W

Recommendation: Go

Interpretation:
Readiness: OK. HRV and RHR both at baseline, sleep decent at 7.8h.
TSB -3.20 = normal mid-week fatigue, nothing concerning. ACWR 1.04 is textbook.
Proceed as planned — keep it controlled and steady. 👍
```

---

## Example 3: Interval Day — Fresh and Ready

```
Data last_updated (UTC): 2026-01-21T08:30:18

Weather (Klampenborg): ❄ -2°C, 65% humidity, Clear, wind 3.8 m/s from the north.
Coach note: Cold and clear — indoor interval day.
...
Planned Workouts for Today (Planned TSS: 84):
VO2 MAX 1.5h - 30s/15s Intervals — 3 sets × 10 reps @ 320W
...
## Example 4: Compromised Readiness — Modify Recommended

```
Data last_updated (UTC): 2026-01-23T07:55:40

Weather (Klampenborg): 🌫 1°C, 91% humidity, Fog, wind 2.1 m/s from the east.
Coach note: Gloomy and damp — indoor day.
...
Planned Workouts for Today (Planned TSS: 90):
Threshold 1.5h — 3x12min @ 260W
